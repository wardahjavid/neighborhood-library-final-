            ...
            while(bookInformationRunning) {
                ...
                switch (selectOption) {
                    ...
                    case "1":
                        ...
                        break;
                    case "2":
                        displayCheckedOutBooks(potatorscanner, book);
                        break;
                    case "3":
        ...
        private static void showAvailableBooks(Scanner potatorscanner, Book[] book) {
            ...
            for (Book book1 : book) {
                if (!book1.isCheckedOut) {
                    System.out.println(book1.getId() + " | " + book1.getIsbn() + " | " + book1.getTitle());
            ...
            System.out.println("Please enter book ID to check out or enter X to return to the home screen. ");
            String enterId = potatorscanner.nextLine();

            if (enterId.equalsIgnoreCase("X")) {
                return;
    ...
    public static void displayCheckedOutBooks(Scanner potatoscanner, Book[] book) {
        ...
        for (Book book1 : book) {
            if (book1.getIsCheckedOut()) {
                System.out.println(book1.checkedOutBookInformation());
        ...
        System.out.println("Please enter book ID to check in or X to go back. ");
        String enterId = potatoscanner.nextLine();
